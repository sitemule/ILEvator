...
///
// Configuration constant for TLS 1
///
dcl-c IV_TLS_1 407;
///
...
//
// Enables or disables a specific SSL version for communication with the server.
//
// @param Pointer to the HTTP client
// @param SSL version (see IV_SSL_x)
...
///
dcl-pr iv_configureSslVersion extproc(*dclcase);
    client pointer value;
